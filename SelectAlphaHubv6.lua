-- SELECT ALPHAHUB - V6 (FIX MOBILE COREGUI ERROR)
...
-- Sửa lỗi CoreGui trên Mobile Executor
...
TeleGrid.CellSize = UDim2.new(0, 75, 0, 30)
...
createToggleRow("Fastmode", function()
    ...
    for _, obj in ipairs(workspace:GetDescendants()) do if obj:IsA("BasePart") then
